...
from nasa import get_apod_images, get_extension
...
def download_images(spacex_url, spacex_path, nasa_url, nasa_path, last_date_epic_url, epic_path, nasa_api_key):
    images_path = []
    spacex_images_path = fetch_spacex_last_launch(spacex_url, spacex_path)
    nasa_images_path = get_apod_images(nasa_url, nasa_path)
...
if __name__ == "__main__":
    ...
    while True:
        images_path = download_images(spacex_url, spacex_path, nasa_url, nasa_path, last_date_epic_url, epic_path, nasa_api_key)
